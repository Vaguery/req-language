...
(fact "by default, the :channels value for a new interpreter is empty"
  (:channels (make-interpreter [1 2])) => {})


(fact "calling make-interpreter with an explicit :channels map creates and sets those"
  (:channels (make-interpreter [1 2] :channels {"x" 8 "y" nil})) => {"x" 8, "y" nil})
